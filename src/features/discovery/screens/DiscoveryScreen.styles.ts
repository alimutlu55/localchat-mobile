...
export const styles = StyleSheet.create({
    ...
    emptyState: {
        ...
        paddingVertical: 14, // Slightly more than ultra-compact to avoid crowding
        paddingHorizontal: 16,
        alignItems: 'center',
        // Still premium but tighter
        shadowColor: '#000',
        shadowOffset: { width: 0, height: 8 },
        shadowOpacity: 0.1,
        shadowRadius: 20,
    ...
    emptyText: {
        fontSize: 14, // Slightly bigger as requested
        color: '#6b7280',
        lineHeight: 20,
        textAlign: 'center',
        marginTop: 4,
        marginBottom: 12, // Gap before button
        fontWeight: '500', // Premium feel
        paddingHorizontal: 4,
    },
    emptyIconContainer: {
        width: 28,
        ...
        justifyContent: 'center',
        alignItems: 'center',
        marginRight: 8, // Inline layout
    },
    emptyHeader: {
        flexDirection: 'row',
        alignItems: 'center',
        marginBottom: 2, // Tighter to title
    },
    createButton: {
        width: '100%',
        paddingVertical: 8,
